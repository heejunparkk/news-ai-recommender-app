...
export function NewsCard({ news, onViewDetails }: NewsCardProps) {
  ...
  const addToRecentlyViewed = useNewsStore(
  ...
  return (
    <Card className="h-full flex flex-col transition-all duration-200 hover:shadow-lg">
      <CardHeader className="p-4 pb-2">
        ...
        <CardTitle
          className="text-lg line-clamp-2 mt-1 cursor-pointer hover:text-primary transition-colors"
      ...
      <CardContent
        className="p-4 pt-3 flex-grow cursor-pointer hover:bg-gray-50 transition-colors"
        onClick={handleViewDetails}
      >
